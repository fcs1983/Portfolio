...
-- ----------------------------------------------------------------------------------------
-- Doc- QUERY016- dbo.GIS_TB01S005_CONTINENTE
--
-- Qual é a área total de todos os continentes?
-- Atenção: Imprimir também o número total de continentes.
--
-- ----------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------
--
Select sum(ext_km2) 'Área dos continentes',
       count(*)     'Total de continentes'
